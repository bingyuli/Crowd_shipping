...
<div id="main_container">
 ...
 <script type="text/javascript">
	...
	{
		var placeholders = ["Larry","Page","test@abc.com","Password","Confirm Password", "San Jose State University"];
	...
	<div class="center_content_pages">
        	...
        	<div class="left_content"> 
                ...
                <h2>Navigate</h2>
                    <ul class="left_menu">
                        <li><h:commandLink action="#{receive.signout}" value="SignOut" ></h:commandLink></li>
...
<div class="right_content">
					...
					<h:panelGrid columns="4">
						...
						<h:inputText id="sourceZip" value="#{receive.fromZip}"></h:inputText>
